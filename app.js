const client = contentful.createClient({
  ...
  accessToken: "5fBuNmmSsHLggWq5eU9m06SPBfPmh6uPF55AprnJU6Y",
});
...
class Product {
  async getProducts() {
    try {
      ...
      let products = contentful.items; // agarra la inf que esta dentro de json, la que esta dentro del keyname "items"
